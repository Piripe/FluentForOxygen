"servers/InternetGamesPage.res"
{
	...
	layout
	{
		region { name="bottom" align=bottom width=max height=44 }
	
		place { control="AddServerButton,RefreshQuickButton,RefreshButton,ConnectButton" region="bottom" margin-right=12 margin-bottom=12 spacing=8 height=32 align=right }
		place { control="Filter,FilterString" region="bottom" width=max end-right="AddServerButton" margin-left=12 margin-bottom=12 spacing=8 height=32 }
